...
export default function OrbLearningPanel({ result }) {
  ...
  return <div className="orb-trials">
    ...
    <section className="orb-lab panel" aria-labelledby="orb-learning-title">
      <div className="section-heading"><div><span className="section-kicker">All experiments visible</span><h2 id="orb-learning-title">ORB comparison</h2></div><span>{trials.length} ORB research trials</span></div>
