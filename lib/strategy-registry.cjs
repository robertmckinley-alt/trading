...
const BACKTEST_STRATEGIES = Object.freeze([...STRATEGIES, ...ORB_RESEARCH_VARIANTS, ...ORB_FILTER_VARIANTS, ...STRATEGY_RESEARCH_VARIANTS, ...ORB_EXTENSION_VARIANTS, ...PRICE_ACTION_VARIANTS]);
