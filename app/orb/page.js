...
export default function OrbPage() {
  return <main className="page-shell research-page" id="main-content">
    ...
    <section className="research-hero backtest-hero"><div><p className="eyebrow">Opening range breakout · January 2025 onward</p><h1>Every ORB experiment. Every result.</h1><p>Compare each variant below, with its own profit curve, annual results, risk rejections, and searchable trade history. No experiment dropdown.</p></div><aside className="research-safety"><strong>Understand the trade count</strong><p>A signal is not a filled trade. Stops, whole-contract sizing, and the risk ceiling can prevent an otherwise valid setup from trading.</p></aside></section>
